...
@AllArgsConstructor
@NoArgsConstructor
@Schema(description = "DTO que representa un comprador en el sistema de login, utilizado para transferir información relevante sobre los compradores entre microservicios.")
