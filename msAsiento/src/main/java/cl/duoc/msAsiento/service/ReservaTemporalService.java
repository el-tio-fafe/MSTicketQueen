...
public class ReservaTemporalService {
    ...
    public String verificarExpiracionPorIdReserva(Integer idReserva){
        ...
        if (reserva.getAsiento().getEstadoAsiento().equals("VENDIDO")) {
            throw new RuntimeException("El asiento " + reserva.getAsiento().getNumeroAsiento() + " ya está vendido");
        }

        if (reserva.getAsiento().getEstadoAsiento().equals("DISPONIBLE")) {
            throw new RuntimeException("El asiento " + reserva.getAsiento().getNumeroAsiento() + " no tiene una reserva activa");
        }
...
// }
    ...
    // Primero buscamos el asiento por número
    Asiento asiento = asientoRepository.findByNumeroAsiento(numeroAsiento)
        .orElseThrow(() -> new RuntimeException("Asiento no encontrado"));
    ...
    // Luego buscamos su reserva activa
    ReservaTemporal reserva = reservaTemporalRepository
