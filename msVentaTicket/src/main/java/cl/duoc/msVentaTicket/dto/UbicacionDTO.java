...
@AllArgsConstructor
@NoArgsConstructor
@Schema(description = "DTO que representa una ubicación en el sistema de venta de tickets, utilizado para transferir información relevante sobre las ubicaciones entre microservicios.")

public class UbicacionDTO {

    @Schema(description = "Identificador único de la ubicación.", example = "1")
    private Integer idUbi;
    @Schema(description = "Nombre de la ubicación.", example = "Platea")
