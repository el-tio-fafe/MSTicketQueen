...
@AllArgsConstructor
@NoArgsConstructor
@Schema(description = "DTO que representa un comprobante en el sistema de venta de tickets, utilizado para transferir información relevante sobre los comprobantes entre microservicios.")
